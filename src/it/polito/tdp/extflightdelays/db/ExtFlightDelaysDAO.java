...
public class ExtFlightDelaysDAO {
	...
	public List<Airport> aeroportiXComp(int comp, Map<Integer,Airport> idMap) {
	...
	public List<Rotta> getRotte(Map<Integer,Airport> idMap) {
		String sql = "SELECT f.ORIGIN_AIRPORT_ID AS oId, f.DESTINATION_AIRPORT_ID AS dId, COUNT(f.ID) AS ct " + 
				"FROM flights f " + 
		...
		try {
			...
			while (rs.next()) {
				...
				Rotta rotta=new Rotta(idMap.get(rs.getInt("oId")), idMap.get(rs.getInt("dId")), rs.getInt("ct"));
				result.add(rotta);
			}
